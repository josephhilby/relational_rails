  ...
  describe 'As a visitor' do
    describe 'When I visit /seasons/:id/storms' do
      it 'Then I see each storm that is associated with that season with each storms attributes' do
        ...
        storm_1 = season.storm.create!(storm_type: "Hurricane", landfall: false, wind_spd: 155, name: "Sam")
        storm_2 = season.storm.create!(storm_type: "Hurricane", landfall: true, wind_spd: 155, name: "Ian")
        visit "/storms"
